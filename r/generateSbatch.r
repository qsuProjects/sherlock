...
# EXAMPLE sbatch_params data frame
# test <- data.frame(jobname = "test_job",
#                    outfile = "testout.out",
#                    errorfile = "testout.err",
#                    jobtime = "00:01:00",
#                    quality = "normal",
#                    node_number = 1,
#                    mem_per_node = 4000,
#                    mailtype =  "ALL",
#                    user_email = "test@stanford.edu",
#                    tasks_per_node = 1,
#                    cpus_per_task = 16,
#                    path_to_r_script = "~/test/test1Batch.R",
#                    args_to_r_script = "1 2 3",
#                    write_path = "~/test1.sbatch",
#                    stringsAsFactors = F)
# sbatch_params <- test
# runfile_path <- "~/testRunFile.R"
...
## write_path: where to write sbatch file(s)
## server_sbatch_path: where sbatch files will be stored on sherlock (i.e. where generated r code should point to)
